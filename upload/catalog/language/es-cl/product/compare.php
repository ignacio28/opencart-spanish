...
$_['text_weight']       = 'Peso';
$_['text_dimension']    = 'Dimensiones (largo x ancho x altura)';
$_['text_compare']      = 'Comparador de productos (%s)';
$_['text_success']      = 'Éxito: ¡Has añadido <a href="%s">%s</a> a tu <a href="%s">comparador de productos</a>!';
$_['text_remove']       = 'Éxito: ¡Has modificado tu comparador de productos!';
$_['text_no_results']   = 'No has elegido productos para comparar.';
