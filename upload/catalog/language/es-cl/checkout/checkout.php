...
$_['text_trial_description']         = 'Entonces %s cada %d %s(s) por %d pago(s)';
$_['text_payment_description']       = '%s cada %d %s(s) por %d pago(s)';
$_['text_payment_cancel']            = '%s cada %d %s(s) hasta ser cancelado';
$_['text_day']                       = 'día';
$_['text_week']                      = 'semana';
...
// Error
$_['error_warning']                  = 'Hubo un problema al intentar procesar tu pedido. Si el problema persiste, intente seleccionar un método de pago diferente o puede comunicarse con el administrador <a href="%s">haciendo clic aquí</a>.';
$_['error_login']                    = 'Aviso: No coincide la dirección de correo electrónico y/o la contraseña.';
...
$_['error_no_shipping']              = 'Aviso: ¡No hay opciones de envío disponibles. <a href="%s">Contáctenos</a> para obtener ayuda¡';
$_['error_payment']                  = 'Aviso: ¡Se requiere el medio de pago!';
$_['error_no_payment']               = 'Aviso: ¡No hay opciones de pago disponibles. <a href="%s">Contáctenos</a> para obtener ayuda!';
